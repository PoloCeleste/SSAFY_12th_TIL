...
![image-20241104100522985](./assets/v-on.png)

```vue
<tag v-on:event="handler"></tag>
```
...
- \$event 변수를 사용하여 메서드에 전달
  ...
  <img src="./assets/InlineHandlers_event.png" alt="image-20241104101344736" style="zoom: 67%;" />
...
- Inline handlers로는 불가능한 대부분의 상황에서 사용
  ...
  <img src="./assets/MethodHandlers.png" alt="image-20241104101628499" style="zoom: 67%;" />
...
1. 단일 체크박스와 **`boolean`** 값 활용
   ...
   <img src="./assets/Checkbox01.png" alt="image-20241104104834748" style="zoom: 50%;" />
...
2. 여러 체크박스와 배열 활용
   ...
   <img src="./assets/Checkbox02.png" alt="image-20241104105052382" style="zoom:67%;" />
...
<img src="./assets/Select.png" alt="image-20241104105256334" style="zoom:67%;" />
