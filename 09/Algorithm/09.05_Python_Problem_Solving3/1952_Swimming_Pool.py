"""
김 프로는 수영장을 이용한다.
김 프로는 지출이 너무 많아 내년 1년 동안 각 달의 이용 계획을 수립하고 
가장 적은 비용으로 수영장을 이용할 수 있는 방법을 찾고 있다.
...
③ 3달 이용권 : 연속된 3달 동안 이용이 가능하다. 3달 이용권은 매달 1일부터 시작한다.
    ...
    다음 해의 이용권만을 구매할 수 있기 때문에 3달 이용권은 
    11월, 12월, 1윌 이나 12월, 1월, 2월 동안 사용하도록 구매할 수는 없다.)
...
|이용하는 방법|이용권|비용|
|1번 경우)<br>모두 1일 이용권으로만 이용한다.|1일 이용권 17개 :<br>17 * 10원 = 170원|170원|
|2번 경우)<br>모두 1달 이용권으로만 이용한다.|1달 이용권 4개 :<br>4 * 40원 = 160원|160원|
|3번 경우)<br>3월은 1일 이용권으로 이용하고<br>4월, 5월, 6월은 3달 이용권으로 이용한다.|1일 이용권 2개, 3달 이용권 1개 :<br>2 * 10원 + 1 * 100원 = 120원|120원|
|4번 경우)<br>3월과 5월은 1일 이용권으로 이용하고<br>4월과 6월은 1달 이용권으로 이용한다.|1일 이용권 3개, 1달 이용권 2개 :<br>3 * 10원 + 2 * 40원 = 110원|110원|
|5번 경우)<br>1년 이용권으로 이용한다.|1년 이용권 1개 :<br>1 * 300원 = 300원|300원|
