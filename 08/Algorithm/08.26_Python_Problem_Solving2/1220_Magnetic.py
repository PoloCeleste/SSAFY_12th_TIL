...
아래는 자성체들이 놓여 있는 테이블을 위에서 바라본 모습이다.
            ...
            N극               N극
        A O b O D O E   O O O O O O O
        O b O O O O O   O O O O O O E
        O O N O O F O   O O O O O F e
        O O O O D f e   O O N O D f O
        O O O O O F O   O O s O D F O
        O O s C O f E   O O O C d f E
        O O A c d O e   O O O c O O e
